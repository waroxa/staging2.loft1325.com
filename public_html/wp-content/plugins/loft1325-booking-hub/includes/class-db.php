...
class Loft1325_DB {
    ...
    public static function create_tables() {
        ...
        CREATE TABLE {$bookings_table} (
            ...
            booking_source ENUM('website','airbnb','admin') NOT NULL DEFAULT 'admin',
            coupon_code VARCHAR(64) NULL,
            identity_type VARCHAR(64) NULL,
            identity_number VARCHAR(128) NULL,
            identity_front_media_id BIGINT UNSIGNED NULL,
            identity_back_media_id BIGINT UNSIGNED NULL,
