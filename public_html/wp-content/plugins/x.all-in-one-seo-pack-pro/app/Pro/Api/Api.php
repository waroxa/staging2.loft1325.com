...
class Api extends CommonApi\Api {
	...
	protected $proRoutes = [
		...
		'POST'   => [
			...
			'search-statistics/keyword-rank-tracker/statistics/(?P<context>keywords|groups)' => [ 'callback' => [ 'SearchStatistics\KeywordRankTracker', 'fetchStatistics' ], 'access' => 'aioseo_search_statistics_settings' ],
