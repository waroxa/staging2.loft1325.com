...
<!--START footer-->
<div style="background-color:<?php echo esc_attr($nd_options_customizer_footer_4_bg); ?>; border-top: 1px solid <?php echo esc_attr($nd_options_customizer_footer_4_border); ?>; <?php echo esc_attr($nd_options_customizer_footer_4_bg_image); ?> " id="nd_options_footer_4" class="nd_options_section">
...
if ( $nd_options_customizer_footer_4_copyright_disable != 1 ) { ?>
    ...
    <!--START copyright-->
    <div style="background-color:<?php echo esc_attr($nd_options_customizer_footer_4_copyright_bg); ?>;" id="nd_options_footer_4_copyright" class="nd_options_section">

        <!--start nd_options_container-->
        <div style="border-top: 1px solid <?php echo esc_attr($nd_options_customizer_footer_4_border); ?> " class="nd_options_container nd_options_clearfix">
            ...
            <div class="grid nd_options_grid_6 nd_options_text_align_center_responsive">
                <p class="nd_options_font_size_14 nd_options_line_height_25_responsive">
                    <?php 
                        ...
                        $nd_options_output_shortcode = do_shortcode($nd_options_customizer_footer_4_left_content); 
            ...
            <div class="grid nd_options_grid_6 nd_options_text_align_right nd_options_text_align_center_responsive">
                <p class="nd_options_font_size_14 nd_options_line_height_25_responsive">
                    <?php 
                        ...
                        $nd_options_output_shortcode = do_shortcode($nd_options_customizer_footer_4_right_content);
                        echo wp_kses( $nd_options_output_shortcode, $nd_options_allowed_html_shortcodes ); 
