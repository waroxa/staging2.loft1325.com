...
<div id="nd_options_footer_1" style="background-color: <?php echo esc_attr($nd_options_customizer_footer_1_bg); ?>" class="nd_options_section nd_options_text_align_center">
    ...
    <div class="nd_options_container nd_options_clearfix">
        ...
        <div class="nd_options_nd_options_grid_12">
        	...
        	<p style="color: <?php echo esc_attr($nd_options_customizer_footer_1_text_color); ?>"><?php echo esc_html($nd_options_customizer_footer_1_content); ?></p>
