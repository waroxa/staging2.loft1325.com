...
<div id="nd_options_footer_3" style="background-color: <?php echo esc_attr($nd_options_customizer_footer_3_bg); ?>" class="nd_options_section nd_options_text_align_center">
    ...
    <div class="nd_options_container nd_options_clearfix">
        ...
        <div class="nd_options_nd_options_grid_12">
        	...
        	<h2 style="color: <?php echo esc_attr($nd_options_customizer_footer_3_text_color); ?>"><?php echo esc_html($nd_options_customizer_footer_3_content_1); ?></h2>
        	<div class="nd_options_section nd_options_height_20"></div>
        	<h5 style="color: <?php echo esc_attr($nd_options_customizer_footer_3_text_color); ?>"><?php echo esc_html($nd_options_customizer_footer_3_content_2); ?></h5>
