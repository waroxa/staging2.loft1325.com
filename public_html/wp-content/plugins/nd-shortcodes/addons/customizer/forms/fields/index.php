...
?>
    ...
    <style type="text/css">
    	...
    	{ 
    		background-color: <?php echo esc_attr($nd_options_customizer_forms_bg); ?>; 
    		border-width: <?php echo esc_attr($nd_options_customizer_forms_border_width); ?>;
    		border-color: <?php echo esc_attr($nd_options_customizer_forms_border_color); ?>;
    		border-radius: <?php echo esc_attr($nd_options_customizer_forms_border_radius); ?>;
    		border-style: solid;
