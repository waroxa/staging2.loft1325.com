...
?>
    ...
    <style type="text/css">
    	...
    	{ 
    		background-color: <?php echo esc_attr($nd_options_customizer_forms_errors_bg); ?>; 
    		border-width: <?php echo esc_attr($nd_options_customizer_forms_errors_border_width); ?> !important;
    		border-color: <?php echo esc_attr($nd_options_customizer_forms_errors_border_color); ?> !important;
    		border-radius: <?php echo esc_attr($nd_options_customizer_forms_errors_border_radius); ?>;
    		border-style: solid;
    		padding: <?php echo esc_attr($nd_options_customizer_forms_errors_padding); ?> !important;
    		color: <?php echo esc_attr($nd_options_customizer_forms_errors_text_color); ?>;
    	...
    	{ 
    		background-color: <?php echo esc_attr($nd_options_customizer_forms_ok_bg); ?>; 
    		border-width: <?php echo esc_attr($nd_options_customizer_forms_errors_border_width); ?>;
    		border-color: <?php echo esc_attr($nd_options_customizer_forms_errors_border_color); ?>;
    		border-radius: <?php echo esc_attr($nd_options_customizer_forms_errors_border_radius); ?>;
    		border-style: solid;
    		padding: <?php echo esc_attr($nd_options_customizer_forms_errors_padding); ?>;
    		color: <?php echo esc_attr($nd_options_customizer_forms_errors_text_color); ?>;
    		margin: 0px;
    		margin-top: 10px;
    		font-size: 13px;
