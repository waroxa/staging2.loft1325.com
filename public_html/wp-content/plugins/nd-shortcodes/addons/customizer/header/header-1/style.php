...
<style type="text/css">
	...
	.nd_options_navigation_1 div > ul > li:after { content: "|"; display: inline-block; margin: 0px 20px; color: <?php echo esc_attr($nd_options_customizer_header_1_divider_color); ?>; }
	.nd_options_navigation_1 div > ul > li:last-child:after { content: ""; margin: 0px; }
	.nd_options_navigation_1 div li a { color: <?php echo esc_attr($nd_options_customizer_header_1_menu_color); ?>; font-size: 16px; }
	...
	.nd_options_navigation_1 .menu ul.sub-menu li.menu-item-has-children > a:after { content:""; float: right; border-style: solid; border-width: 5px 0 5px 5px; border-color: transparent transparent transparent <?php echo esc_attr($nd_options_customizer_font_color_h); ?>; margin-top: 3px; }
