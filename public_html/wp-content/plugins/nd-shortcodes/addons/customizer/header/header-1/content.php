...
<!--START section-->
<div id="nd_options_header" style="background-color: <?php echo esc_attr($nd_options_customizer_header_1_bg); ?> ;" class="nd_options_section">
    ...
    <div class="nd_options_container nd_options_clearfix">
        ...
        <div class="nd_options_grid_3 nd_options_text_align_center_responsive">
        	...
        	<a class="" href="<?php echo esc_url(home_url()); ?>"><h3 style="color: <?php echo esc_attr($nd_options_customizer_header_1_menu_color); ?> ;"><?php echo esc_html(get_bloginfo( 'name' )); ?></h3></a>
        	<div class="nd_options_section nd_options_height_10"></div>
        	<a href="<?php echo esc_url(home_url()); ?>"><p style="color: <?php echo esc_attr($nd_options_customizer_header_1_tagline_color); ?> ;" class="nd_options_font_size_13"><?php echo esc_html(get_bloginfo( 'description' )); ?></p></a>
        	<div class="nd_options_section nd_options_height_10"></div>
        </div>
