...
<div style="background-color: <?php echo esc_attr($nd_options_customizer_header_2_bg_responsive); ?> ;" class="nd_options_navigation_2_sidebar_content nd_options_padding_40 nd_options_box_sizing_border_box nd_options_overflow_hidden nd_options_overflow_y_auto nd_options_transition_all_08_ease nd_options_height_100_percentage nd_options_position_fixed nd_options_width_300 nd_options_right_300_negative nd_options_z_index_999">
...
<?php if ( $nd_options_customizer_top_header_2_display != 1 ) { ?>
	...
	<!--start TOP header-->
	<div class="nd_options_section <?php echo esc_attr($nd_options_customizer_top_header_2_display_responsive_class); ?> ">

	    <div id="nd_options_navigation_2_top_header" style="background-color: <?php echo esc_attr($nd_options_customizer_top_header_2_bg); ?> ;" class="nd_options_section">

	        <!--start nd_options_container-->
	        <div class="nd_options_container nd_options_clearfix">

	            <div style="color: <?php echo esc_attr($nd_options_customizer_top_header_2_text_color); ?> ;" class="nd_options_grid_6 nd_options_padding_botttom_10 nd_options_padding_bottom_0_responsive nd_options_padding_top_10 nd_options_text_align_center_responsive">
	            	<div id="nd_options_navigation_top_header_2_left" class="nd_options_navigation_top_header_2 nd_options_display_inline_block_responsive">
	            		<?php 

	            			$nd_options_output_shortcode = do_shortcode($nd_options_customizer_top_header_2_left_content); 
	            ...
	            <div style="color: <?php echo esc_attr($nd_options_customizer_top_header_2_text_color); ?> ;" class="nd_options_grid_6 nd_options_text_align_right nd_options_text_align_center_responsive nd_options_padding_top_0_responsive nd_options_padding_botttom_10 nd_options_padding_top_10">
	           		<div id="nd_options_navigation_top_header_2_right" class="nd_options_navigation_top_header_2 nd_options_display_inline_block_responsive">
	           			<?php 

	           				$nd_options_output_shortcode = do_shortcode($nd_options_customizer_top_header_2_right_content);
	           				echo wp_kses( $nd_options_output_shortcode, $nd_options_allowed_html_shortcodes ); 
    ...
    <div style="background-color: <?php echo esc_attr($nd_options_customizer_header_2_bg); ?> ; border-bottom: 1px solid <?php echo esc_attr($nd_options_customizer_header_2_divider_color); ?> ;" class="nd_options_section">
        ...
        <div class="nd_options_container nd_options_clearfix nd_options_position_relative">
            ...
            <div class="nd_options_grid_12 nd_options_display_none_all_responsive">
                ...
                <div style="height: <?php echo esc_attr($nd_options_customizer_header_2_margin); ?>px;" class="nd_options_section"></div>

                <!--LOGO-->
                <a href="<?php echo esc_url(home_url()); ?>"><img style="top:<?php echo esc_attr($nd_options_customizer_header_2_logo_margin_top); ?>px;" alt="" class="nd_options_position_absolute nd_options_left_15" width="<?php echo esc_attr($nd_options_customizer_header_2_logo_width); ?>" src="<?php echo esc_url($nd_options_customizer_header_2_logo); ?>"></a>
			...
			<div class="nd_options_section nd_options_text_align_center nd_options_display_none nd_options_display_block_responsive">
				...
				<div class="nd_options_section">
			        <a class="nd_options_open_navigation_2_sidebar_content nd_options_open_navigation_2_sidebar_content" href="#">
			            <img alt="" class="" width="25" src="<?php echo esc_url($nd_options_customizer_header_2_icon_responsive_menu); ?>">
			        </a>
			    </div>
