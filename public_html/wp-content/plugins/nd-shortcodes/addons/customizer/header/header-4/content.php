...
<?php if ( $nd_options_customizer_top_header_4_display != 1 ) { ?>
	...
	<div class="nd_options_section">
	    ...
	    <div id="nd_options_navigation_4_top_header" style="background-color: <?php echo esc_attr($nd_options_customizer_top_header_4_bg); ?> ;" class="nd_options_section">

	        <!--start nd_options_container-->
	        <div class="nd_options_container nd_options_clearfix">

	            <div style="color: <?php echo esc_attr($nd_options_customizer_top_header_4_text_color); ?> ;" class="nd_options_grid_6 nd_options_padding_botttom_10 nd_options_padding_bottom_0_responsive nd_options_padding_top_10 nd_options_text_align_center_responsive">
	            	<div id="nd_options_navigation_top_header_4_left" class="nd_options_navigation_top_header_4 nd_options_display_inline_block_responsive">
	            		<?php 

	            			$nd_options_output_shortcode = do_shortcode($nd_options_customizer_top_header_4_left_content); 
	            ...
	            <div style="color: <?php echo esc_attr($nd_options_customizer_top_header_4_text_color); ?> ;" class="nd_options_grid_6 nd_options_text_align_right nd_options_text_align_center_responsive nd_options_padding_top_0_responsive nd_options_padding_botttom_10 nd_options_padding_top_10">
	           		<div id="nd_options_navigation_top_header_4_right" class="nd_options_navigation_top_header_4 nd_options_display_inline_block_responsive">
	           			<?php 

	           				$nd_options_output_shortcode = do_shortcode($nd_options_customizer_top_header_4_right_content);
	           				echo wp_kses( $nd_options_output_shortcode, $nd_options_allowed_html_shortcodes ); 
...
<!--START LOGO-->
<div id="nd_options_navigation_4_middle_header" style="background-color: <?php echo esc_attr($nd_options_customizer_header_4_bg); ?> ;" class="nd_options_section nd_options_display_none_all_responsive">

    <div class="nd_options_container nd_options_clearfix">

        <div style="height: <?php echo esc_attr($nd_options_customizer_header_4_margin); ?>px;" class="nd_options_section"></div>

        <div class="nd_options_grid_12 nd_options_display_none_all_responsive nd_options_text_align_center">

            <a href="<?php echo esc_url(home_url()); ?>"><img style="margin-top:<?php echo esc_attr($nd_options_customizer_header_2_logo_margin_top); ?>px;" alt="" class="" width="<?php echo esc_attr($nd_options_customizer_header_2_logo_width); ?>" src="<?php echo esc_url($nd_options_customizer_header_2_logo); ?>"></a>
...
<div id="nd_options_navigation_4_container" class="nd_options_section nd_options_position_relative ">
    ...
    <div style="background-color: <?php echo esc_attr($nd_options_customizer_header_4_bg); ?> ; border-bottom: 1px solid <?php echo esc_attr($nd_options_customizer_header_4_divider_color); ?> ; border-top: 1px solid <?php echo esc_attr($nd_options_customizer_header_4_divider_color); ?> ;" class="nd_options_section">
        ...
        <div class="nd_options_section nd_options_padding_15 nd_options_box_sizing_border_box nd_options_position_relative">
			...
			<div class="nd_options_section nd_options_text_align_center nd_options_display_none nd_options_display_block_responsive">
			    ...
			    <a class="nd_options_display_inline_block" href="<?php echo esc_url(home_url()); ?>"><img alt="" class="nd_options_float_left nd_options_max_width_280_iphone_port" width="<?php echo esc_attr($nd_options_customizer_header_2_logo_width); ?>" src="<?php echo esc_url($nd_options_customizer_header_2_logo_responsive); ?>"></a> 
				
				<div class="nd_options_section nd_options_height_10"></div>

				<div class="nd_options_section">
			        <a class="nd_options_open_navigation_4_sidebar_content nd_options_open_navigation_4_sidebar_content" href="#">
			            <img alt="" class="" width="25" src="<?php echo esc_url($nd_options_customizer_header_4_icon_responsive_menu); ?>">
			        </a>
			    </div>
