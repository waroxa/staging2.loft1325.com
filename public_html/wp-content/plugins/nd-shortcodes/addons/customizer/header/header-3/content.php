...
<?php if ( $nd_options_customizer_top_header_3_display != 1 ) { ?>
	...
	<div class="nd_options_section">
	    ...
	    <div id="nd_options_navigation_3_top_header" style="background-color: <?php echo esc_attr($nd_options_customizer_top_header_3_bg); ?> ;" class="nd_options_section">

	        

	            <div style="color: <?php echo esc_attr($nd_options_customizer_top_header_3_text_color); ?> ;" class="nd_options_grid_6 nd_options_padding_botttom_10 nd_options_padding_bottom_0_responsive nd_options_padding_top_10 nd_options_text_align_center_responsive">
	            	<div id="nd_options_navigation_top_header_3_left" class="nd_options_navigation_top_header_3 nd_options_display_inline_block_responsive">
	            		<?php 
	            			...
	            			$nd_options_output_shortcode = do_shortcode($nd_options_customizer_top_header_3_left_content); 
	            ...
	            <div style="color: <?php echo esc_attr($nd_options_customizer_top_header_3_text_color); ?> ;" class="nd_options_grid_6 nd_options_text_align_right nd_options_text_align_center_responsive nd_options_padding_top_0_responsive nd_options_padding_botttom_10 nd_options_padding_top_10">
	           		<div id="nd_options_navigation_top_header_3_right" class="nd_options_navigation_top_header_3 nd_options_display_inline_block_responsive">
	           			<?php 
	           				...
	           				$nd_options_output_shortcode = do_shortcode($nd_options_customizer_top_header_3_right_content);
	           				echo wp_kses( $nd_options_output_shortcode, $nd_options_allowed_html_shortcodes ); 
...
<div id="nd_options_navigation_3_container" class="nd_options_section nd_options_position_relative ">
    ...
    <div style="background-color: <?php echo esc_attr($nd_options_customizer_header_3_bg); ?> ; border-bottom: 1px solid <?php echo esc_attr($nd_options_customizer_header_3_divider_color); ?> ;" class="nd_options_section">

      
        <div class="nd_options_grid_12 nd_options_display_none_all_responsive">

            <div style="height: <?php echo esc_attr($nd_options_customizer_header_3_margin); ?>px;" class="nd_options_section"></div>

            <!--LOGO-->
            <a href="<?php echo esc_url(home_url()); ?>"><img id="nd_options_logo_header_3" style="top:<?php echo esc_attr($nd_options_customizer_header_2_logo_margin_top); ?>px;" alt="" class="nd_options_position_absolute nd_options_left_15" width="<?php echo esc_attr($nd_options_customizer_header_2_logo_width); ?>" src="<?php echo esc_url($nd_options_customizer_header_2_logo); ?>"></a>
            ...
            <?php $nd_options_customizer_header_3_marginn = 15+$nd_options_customizer_header_3_margin; ?>

            <!--RIGHT CONTENT-->
            <div style="top:<?php echo esc_attr($nd_options_customizer_header_3_marginn); ?>px;" class="nd_options_position_absolute nd_options_right_20">
            	<?php 

            		$nd_options_output_shortcode = do_shortcode($nd_options_customizer_header_3_right_content); 
            		echo wp_kses( $nd_options_output_shortcode, $nd_options_allowed_html_shortcodes ); 
		...
		<div class="nd_options_section nd_options_text_align_center nd_options_display_none nd_options_display_block_responsive">
		    ...
		    <a class="nd_options_display_inline_block" href="<?php echo esc_url(home_url()); ?>"><img alt="" class="nd_options_float_left" width="<?php echo esc_attr($nd_options_customizer_header_2_logo_width); ?>" src="<?php echo esc_url($nd_options_customizer_header_2_logo_responsive); ?>"></a> 
			
			<div class="nd_options_section nd_options_height_10"></div>

			<div class="nd_options_section">
		        <a class="nd_options_open_navigation_3_sidebar_content nd_options_open_navigation_3_sidebar_content" href="#">
		            <img alt="" class="" width="25" src="<?php echo esc_url($nd_options_customizer_header_3_icon_responsive_menu); ?>">
		        </a>
		    </div>
