...
<style type="text/css">
	...
	.nd_options_navigation_3 div > ul > li:after { content: ""; display: inline-block; margin: 0px 20px; color: <?php echo esc_attr($nd_options_customizer_header_3_divider_color); ?>; }
	.nd_options_navigation_3 div > ul > li:last-child:after { content: ""; margin: 0px; }
	.nd_options_navigation_3 div li a { color: <?php echo esc_attr($nd_options_customizer_header_3_menu_color); ?>; font-size: 16px; line-height: 16px; font-family: <?php echo esc_attr($nd_options_font_family_h); ?>; }
	...
	.nd_options_navigation_3 div > ul li > ul.sub-menu li a { font-size: 14px; color: <?php echo esc_attr($nd_options_customizer_font_color_h); ?>; float: left; width: 100%;  }
	.nd_options_navigation_3 div > ul li > ul.sub-menu li > ul.sub-menu { margin-left: 170px; top: 0; padding-top: 0; padding-left: 20px; }
	/*responsive*/
	.nd_options_navigation_3_sidebar div > ul { list-style: none; margin: 0px; padding: 0px; }
	.nd_options_navigation_3_sidebar div > ul > li { display: inline-block; width: 100%; padding: 0px 0px 20px 0px; }
	.nd_options_navigation_3_sidebar div li a { font-family: <?php echo esc_attr($nd_options_font_family_h); ?>; }
	.nd_options_navigation_3_sidebar div li > a { padding: 10px 0px; display: inline-block; font-size: 24px; font-family: <?php echo esc_attr($nd_options_font_family_h); ?>; text-transform: lowercase; color: #fff; }
	...
	.nd_options_navigation_3 .menu ul.sub-menu li.menu-item-has-children > a:after { content:""; float: right; border-style: solid; border-width: 5px 0 5px 5px; border-color: transparent transparent transparent <?php echo esc_attr($nd_options_customizer_font_color_h); ?>; margin-top: 3px; }
