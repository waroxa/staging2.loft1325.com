      ...
      <div class="nd_options_section nd_options_min_height_400 nd_options_box_shadow_0_1_1_000_04 nd_options_background_color_ffffff nd_options_border_1_solid_e5e5e5 nd_options_border_top_width_0 nd_options_border_left_width_0 nd_options_overflow_hidden nd_options_position_relative">
        ...
        <div style="background-color:<?php echo esc_attr(nd_options_get_profile_bg_color(1)); ?>;" class="nd_options_width_20_percentage nd_options_float_left nd_options_box_sizing_border_box nd_options_min_height_3000 nd_options_position_absolute">
          ...
          <ul class="nd_options_navigation">
            ...
            <li><a class="" href="<?php echo esc_url(admin_url('admin.php?page=nd-shortcodes-settings-import-demo')); ?>"><?php _e('Import Demo','nd-shortcodes'); ?></a></li>

            <?php

            if ( get_option('nd_options_locations_enable') == 1 ) { ?>

            <li><a style="background-color:<?php echo esc_attr(nd_options_get_profile_bg_color(2)); ?>;" href=""><?php _e('Locations','nd-shortcodes'); ?></a></li>
