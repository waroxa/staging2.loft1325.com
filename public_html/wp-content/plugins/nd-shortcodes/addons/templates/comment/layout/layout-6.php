...
if ( $nd_options_meta_box_post_color == '' ) { $nd_options_meta_box_post_color = '#434a54'; }
...
<style type="text/css">
    ...
    .nd_options_comments_ul li .reply a.comment-reply-link { font-family: '<?php echo esc_attr($nd_options_font_family_p); ?>', sans-serif; }
    ...
    /*font and color*/
    .nd_options_comments_ul li .comment-author .fn, 
    .nd_options_comments_ul li .comment-author .fn a { color: <?php echo esc_attr($nd_options_customizer_font_color_h);  ?>; }
    .nd_options_comments_ul li .comment-author .fn, 
    .nd_options_comments_ul li .comment-author .fn a { font-family: '<?php echo esc_attr($nd_options_font_family_h); ?>', sans-serif; }
    .nd_options_comments_ul li .reply a.comment-reply-link { background-color: <?php echo esc_attr($nd_options_meta_box_post_color); ?>; }
    #nd_options_comments_form input[type='submit'] { background-color: <?php echo esc_attr($nd_options_meta_box_post_color); ?>; }
    #nd_options_comments_form #commentform.comment-form input[type='submit'] { background-color: <?php echo esc_attr($nd_options_meta_box_post_color); ?>; }


    /*compatibility for nd-learning*/
    #nd_learning_single_course_comments .nd_options_comments_ul li .comment-author .fn, 
    #nd_learning_single_course_comments .nd_options_comments_ul li .comment-author .fn a { color: <?php echo esc_attr($nd_options_customizer_font_color_h);  ?>; }
    #nd_learning_single_course_comments .nd_options_comments_ul li .comment-author .fn, 
    #nd_learning_single_course_comments .nd_options_comments_ul li .comment-author .fn a { font-family: '<?php echo esc_attr($nd_options_font_family_h); ?>', sans-serif; }
...
<?php if ( have_comments() ) : ?>
    ...
    <div id="nd_options_comments" class="nd_options_section nd_options_margin_top_50 nd_options_padding_top_50 nd_options_border_top_1_solid_grey">
        ...
        <h3 class=""><?php comments_number(__('No Comments','nd-shortcodes'),__('One Comment','nd-shortcodes'),__( '% Comments','nd-shortcodes') );?></h3>
