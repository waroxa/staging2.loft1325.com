...
if ( $nd_options_customizer_archives_search_image_display != 1 ) { ?>
	...
	<div class="nd_options_section nd_options_background_size_cover <?php echo esc_attr($nd_options_customizer_archives_search_image_position); ?> nd_options_bg_greydark" style="background-image:url(<?php echo esc_url($nd_options_customizer_archives_search_image); ?>);">
				...
				<?php while(have_posts()) : the_post(); ?>
					...
					<div class="nd_options_width_33_percentage nd_options_padding_15 nd_options_box_sizing_border_box nd_options_masonry_item nd_options_width_100_percentage_responsive">
					    <div id="post-<?php the_ID(); ?>" <?php post_class(); ?> >
						  	<div class="nd_options_section nd_options_padding_40 nd_options_box_sizing_border_box nd_options_background_size_cover" style="background-image:url(<?php echo esc_url($nd_options_image_attributes[0]); ?>);">
					            <div class="nd_options_section nd_options_bg_white_alpha_97 nd_options_padding_40 nd_options_box_sizing_border_box nd_options_text_align_center">
					                <h3 class="nd_options_color_grey"><?php echo esc_html($nd_options_title); ?></h3>
					                ...
					                <div class="nd_options_section nd_options_height_20"></div>
					                <p><?php echo esc_html($nd_options_excerpt); ?></p>
					                <div class="nd_options_section nd_options_height_20"></div>
					                <a class="nd_options_display_inline_block nd_options_border_1_solid_grey nd_options_text_align_center nd_options_line_height_16 nd_options_box_sizing_border_box  nd_options_color_grey nd_options_first_font nd_options_padding_10_20" href="<?php echo esc_url($nd_options_permalink); ?>">
