...
<style type="text/css">
    ...
    .nd_options_sidebar .widget.widget_search input[type="submit"] { margin-top: 20px; letter-spacing: 2px; text-transform: uppercase; font-weight: normal; font-size: 12px; font-family: '<?php echo esc_attr($nd_options_font_family_p); ?>', sans-serif; }
    ...
    .nd_options_sidebar .widget.widget_calendar table tfoot td a { color: #fff; background-color: <?php echo esc_attr($nd_options_customizer_forms_submit_bg); ?>; padding: 5px; border-radius: 0px; font-size: 12px; text-transform: uppercase; }
    ...
    /*color calendar*/
    .nd_options_sidebar .widget.widget_calendar table thead { color: <?php echo esc_attr($nd_options_customizer_font_color_p);  ?>; }
    ...
    .nd_options_sidebar .widget.widget_calendar table caption { color:#fff; font-family: '<?php echo esc_attr($nd_options_font_family_h); ?>', sans-serif; }
