...
$nd_options_layout_selected = dirname( __FILE__ ).'/sidebar/layout-2.php';
                ...
                <div class="nd_options_section nd_options_bg_greydark_alpha_2">
                    ...
                    <div class="nd_options_container nd_options_clearfix">
                        ...
                        <div class="nd_options_section nd_options_text_align_center nd_options_text_align_left_all_iphone nd_options_padding_15 nd_options_box_sizing_border_box">
                            ...
                            <h1 class="nd_options_color_white nd_options_font_size_45 nd_options_font_size_40_all_iphone nd_options_line_height_40_all_iphone nd_options_first_font"><?php echo esc_html($nd_options_meta_box_post_header_img_title); ?></h1>
                            ...
                            <div class="nd_options_section">
                                <div class="nd_options_display_inline_block">
                                    ...
                                    <div class="nd_options_section nd_options_position_relative nd_options_padding_right_40 nd_options_box_sizing_border_box">
                                        ...
                                        <div class="nd_options_section nd_options_padding_left_45 nd_options_box_sizing_border_box">
                                            ...
                                            <h3 class="nd_options_color_white nd_options_second_font"><?php echo esc_html(get_the_author()); ?></h3>
                                        </div>
                                    </div>
                                    <div class="nd_options_section nd_options_height_10"></div>
                                ...
                                <div class="nd_options_display_inline_block">
                                    ...
                                    <div class="nd_options_section nd_options_position_relative nd_options_padding_right_40 nd_options_box_sizing_border_box">
                                        ...
                                        <div class="nd_options_section nd_options_padding_left_45 nd_options_box_sizing_border_box">
                                            <div class="nd_options_section nd_options_height_5"></div>
                                            <h3 class="nd_options_color_white nd_options_second_font"><?php echo esc_html(the_time('d F Y')); ?></h3>
                                        </div>
                                    </div>
                                    <div class="nd_options_section nd_options_height_10"></div>
                                ...
                                <div class="nd_options_display_inline_block">
                                    ...
                                    <div class="nd_options_section nd_options_position_relative">
                                        ...
                                        <div class="nd_options_section nd_options_padding_left_45 nd_options_box_sizing_border_box">
                                            <div class="nd_options_section nd_options_height_5"></div>
                                            <h3 class="nd_options_color_white nd_options_second_font"><?php echo esc_html(comments_number()); ?></h3>
                                        </div>
                                    </div>
                                    <div class="nd_options_section nd_options_height_10"></div>
