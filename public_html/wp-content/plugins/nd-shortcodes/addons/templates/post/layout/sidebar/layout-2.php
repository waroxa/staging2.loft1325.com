...
<style type="text/css">
    ...
    .nd_options_sidebar .widget h3 { font-weight: normal; background-color:<?php echo esc_attr($nd_options_meta_box_post_color); ?>; color:#fff; padding: 20px; font-size: 17px; }
    ...
    .nd_options_sidebar .widget.widget_calendar table caption { font-size: 17px; font-weight: normal; background-color:<?php echo esc_attr($nd_options_meta_box_post_color); ?>;  padding: 20px; border-bottom: 0px; margin-bottom: 10px; }
