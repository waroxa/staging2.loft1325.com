...
<style type="text/css">
    ...
    .nd_options_sidebar .widget.widget_search input[type="submit"] { margin-top: 20px; letter-spacing: 1px; text-transform: uppercase; font-weight: normal; font-size: 14px; font-family: '<?php echo esc_attr($nd_options_font_family_p); ?>', sans-serif; }
