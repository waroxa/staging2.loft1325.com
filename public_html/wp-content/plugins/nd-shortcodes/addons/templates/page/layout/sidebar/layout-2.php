...
function nd_options_customizer_page_sidebar_layout_2(){ 
    ...
    <style type="text/css">
        ...
        .wpb_widgetised_column .widget h3 { font-weight: normal; background-color:<?php echo esc_attr($nd_options_meta_box_page_color); ?>; color:#fff; padding: 20px; font-size: 17px; }
        ...
        .wpb_widgetised_column .widget.widget_calendar table caption { font-size: 17px; font-weight: normal; background-color:<?php echo esc_attr($nd_options_meta_box_page_color); ?>;  padding: 20px; border-bottom: 0px; margin-bottom: 10px; }

        /*color calendar*/
        .wpb_widgetised_column .widget.widget_calendar table thead { color: <?php echo esc_attr($nd_options_customizer_font_color_h);  ?>; }
        .wpb_widgetised_column .widget.widget_calendar table tbody td a { background-color: <?php echo esc_attr($nd_options_customizer_forms_submit_bg); ?>; }
        .wpb_widgetised_column .widget.widget_calendar table caption { color: #fff; font-family: '<?php echo esc_attr($nd_options_font_family_h); ?>', sans-serif; }
