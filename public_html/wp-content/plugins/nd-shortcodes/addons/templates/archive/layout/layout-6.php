...
if ( $nd_options_customizer_archives_archive_image_display != 1 ) { ?>
	...
	<div id="nd_options_archives_header_img_layout_6" class="nd_options_section nd_options_background_size_cover <?php echo esc_attr($nd_options_customizer_archives_archive_image_position); ?> nd_options_bg_greydark" style="background-image:url(<?php echo esc_url($nd_options_customizer_archives_archive_image); ?>);">
					...
					<div class=" nd_options_width_33_percentage nd_options_padding_15 nd_options_box_sizing_border_box nd_options_masonry_item nd_options_width_100_percentage_responsive">
					    <div class="nd_options_section nd_options_border_1_solid_grey nd_options_bg_white">
					        ...
					        <div class="nd_options_section nd_options_padding_30 nd_options_box_sizing_border_box">
					        	...
					        	<h3 class="nd_options_margin_0_important nd_options_font_weight_normal"><?php echo esc_html($nd_options_title); ?></h3>
					            ...
					            <a style="border: 1px solid #f1f1f1;" class="nd_options_display_inline_block nd_options_line_height_11 nd_options_text_align_center nd_options_box_sizing_border_box   nd_options_second_font nd_options_padding_15_30  " href="<?php echo esc_url($nd_options_permalink); ?>"><?php _e('READ MORE','nd-shortcodes'); ?></a>
