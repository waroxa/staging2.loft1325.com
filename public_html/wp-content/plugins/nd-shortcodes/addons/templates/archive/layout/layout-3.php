...
if ( $nd_options_customizer_archives_archive_image_display != 1 ) { ?>
	...
	<div id="nd_options_archives_header_img_layout_3" class="nd_options_section nd_options_background_size_cover <?php echo esc_attr($nd_options_customizer_archives_archive_image_position); ?> nd_options_bg_greydark" style="background-image:url(<?php echo esc_url($nd_options_customizer_archives_archive_image); ?>);">
