...
if ( $nd_options_customizer_archives_archive_image_display != 1 ) { ?>
	...
	<div id="nd_options_archives_header_img_layout_9" class="nd_options_section nd_options_background_size_cover <?php echo esc_attr($nd_options_customizer_archives_archive_image_position); ?> nd_options_bg_greydark" style="background-image:url(<?php echo esc_url($nd_options_customizer_archives_archive_image); ?>);">
					...
					<div class=" nd_options_width_33_percentage nd_options_padding_15 nd_options_box_sizing_border_box nd_options_masonry_item nd_options_width_100_percentage_responsive">
					    <div class="nd_options_section nd_options_box_shadow_0_0_15_0_0001  nd_options_bg_white">
					        ...
					        <div class="nd_options_section nd_options_padding_30 nd_options_box_sizing_border_box">
					        	...
					        	<h3 class="nd_options_letter_spacing_1 nd_options_font_size_23"><strong><?php echo esc_html($nd_options_title); ?></strong></h3>
						        <div class="nd_options_section nd_options_height_20"></div>
						        <p class="nd_options_line_height_2_em"><?php echo esc_html($nd_options_excerpt); ?></p>
						        <div class="nd_options_section nd_options_height_20"></div>
						        <a style="background-color: <?php echo esc_attr($nd_options_meta_box_page_color); ?>;" class="nd_options_display_inline_block nd_options_line_height_16 nd_options_font_size_13 nd_options_text_align_center nd_options_box_sizing_border_box  nd_options_color_white nd_options_first_font nd_options_padding_10_20 nd_options_font_weight_bold nd_options_letter_spacing_1" href="<?php echo esc_url($nd_options_permalink); ?>"><?php _e('READ MORE','nd-shortcodes'); ?></a>
