...
if ( $nd_options_customizer_archives_archive_image_display != 1 ) { ?>
	...
	<div id="nd_options_archives_header_img_layout_4" class="nd_options_section nd_options_background_size_cover <?php echo esc_attr($nd_options_customizer_archives_archive_image_position); ?> nd_options_bg_greydark" style="background-image:url(<?php echo esc_url($nd_options_customizer_archives_archive_image); ?>);">
					...
					<div class="nd_options_width_33_percentage nd_options_padding_15 nd_options_box_sizing_border_box nd_options_masonry_item nd_options_width_100_percentage_responsive">
						<div class="nd_options_section nd_options_border_1_solid_grey">
						    ...
						    <div class="nd_options_section nd_options_padding_40 nd_options_box_sizing_border_box">
						        <h3><a class="nd_options_first_font nd_options_color_greydark" href="<?php echo esc_url($nd_options_permalink); ?>"><?php echo esc_html($nd_options_title); ?></a></h3>
						        <div class="nd_options_section nd_options_height_10"></div>
						        <p><a href="<?php echo esc_url($nd_options_permalink); ?>"><?php echo esc_html($nd_options_excerpt); ?></a></p>
						        <div class="nd_options_section nd_options_height_10"></div>
						        <a style="color:<?php echo esc_attr($nd_options_meta_box_page_color); ?>;" class="nd_options_display_inline_block nd_options_first_font nd_options_font_size_13" href="<?php echo esc_url($nd_options_permalink); ?>"><strong><?php _e('READ MORE','nd-shortcodes'); ?></strong></a>
						    </div>
