<div id="nd_options_woocommerce_header_img_layout_7" class="nd_options_section nd_options_background_size_cover <?php echo esc_attr($nd_options_meta_box_woocommerce_header_img_position); ?>" style="background-image:url(<?php echo esc_url($nd_options_meta_box_woocommerce_header_img); ?>);">
