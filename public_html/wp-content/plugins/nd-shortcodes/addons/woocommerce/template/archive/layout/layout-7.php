<div id="nd_options_woocommerce_archives_header_img_layout_7" class="nd_options_section nd_options_bg_greydark nd_options_background_size_cover <?php echo esc_attr($nd_options_customizer_woocommerce_archive_products_header_image_position); ?>" style="background-image:url(<?php echo esc_url($nd_options_customizer_woocommerce_archive_products_header_image_src); ?>);">
