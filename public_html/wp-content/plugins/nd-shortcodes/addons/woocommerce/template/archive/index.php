...
if ( $nd_options_customizer_woocommerce_archive_products_header_image_display != 1 ) { 	
    ...
    $nd_options_layout_selected = dirname( __FILE__ ).'/layout/'.$nd_options_customizer_woocommerce_archive_products_layout_header_img.'.php';    
...
<div class=" nd_options_woo_template_archive_<?php echo esc_attr($nd_options_customizer_woocommerce_archive_products_layout_header_img); ?> nd_options_container nd_options_padding_0 nd_options_box_sizing_border_box nd_options_clearfix">
