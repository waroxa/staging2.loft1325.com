...
.nd_options_focus_number_2_vertical_line:after{
  content:"";width: 0px;height: 100%;position: absolute;left: 40px;z-index: 9;border-left: 2px dashed #f1f1f1; 
}

';

wp_add_inline_style('nd_options_focus_number_style',$nd_options_style);
