...
<div class="nd_elements_section nd_elements_masonry_content nd_elements_posgrid_widget_l5">';
	...
	while ( $the_query->have_posts() ) : $the_query->the_post();
		...
		if ( has_post_format('quote') ) {
			...
			$nd_elements_result .= '
	    	<div class=" '.$postgrid_width.' nd_elements_width_100_percentage_responsive nd_elements_float_left nd_elements_masonry_item nd_elements_preview_post_image nd_elements_padding_15 nd_elements_box_sizing_border_box">
