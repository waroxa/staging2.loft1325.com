...
$nd_booking_branch_select_enable = get_option('nd_booking_branch_select_enable'); 
if ( $nd_booking_branch_select_enable == 1 and get_option('nicdark_theme_author') == 1 ) { $nd_booking_branch_select_class = 'nd_booking_padding_15'; }else{ $nd_booking_branch_select_class = ''; }
    ...
    <form id="nd_booking_search_cpt_1_form_sidebar">
        ...
        <div class="nd_booking_section nd_booking_padding_15 nd_booking_padding_0_responsive nd_booking_box_sizing_border_box">
          ...
          <div id="nd_booking_search_main_bg" class="nd_booking_section nd_booking_bg_greydark nd_booking_padding_15 nd_booking_padding_0_responsive nd_booking_box_sizing_border_box">
            ...
            <!--branches-->
            <div id="nd_booking_search_cpt_1_form_branches" class="  nd_booking_width_100_percentage nd_booking_float_left '.$nd_booking_branch_select_class.' nd_booking_padding_0_responsive nd_booking_box_sizing_border_box">';
              
            	
            	//START new branch select option
            	if ( $nd_booking_branch_select_enable == 1 and get_option('nicdark_theme_author') == 1 ){
	            	...
	            	<ul class="nd_booking_branch_ul_1 nd_booking_bg_greydark_2">
	            		...
	            		<li class="nd_booking_branch_select_active">
	            			<h3 class="nd_options_color_white">'.__('All Branches','nd-booking').'</h3>
	            			<img class="nd_booking_branch_ul_1_arrow" alt="" width="12" src="'.esc_url(plugins_url('icon-down-arrow-white.svg', __FILE__ )).'">
	            		</li>';

	            		$nd_booking_branches_args_1 = array( 'posts_per_page' => -1, 'post_type'=> 'nd_booking_cpt_4' );
	            		$nd_booking_branches_1 = get_posts($nd_booking_branches_args_1); 
	            		foreach ($nd_booking_branches_1 as $nd_booking_meta_box_branche_1) :

	            			$nd_booking_shortcode_left_content .= '
	            			<li>
	            				<h3 class="nd_options_color_white">'.$nd_booking_meta_box_branche_1->post_title.'</h3>
	            				<img class="nd_booking_branch_ul_1_arrow" alt="" width="12" src="'.esc_url(plugins_url('icon-down-arrow-white.svg', __FILE__ )).'">
	            			</li>
	            			';	
	            		...
	            		$nd_booking_shortcode_left_content .= '
	            		<ul class="nd_booking_branch_select_sub_menu nd_booking_bg_greydark_2">
	            			<li data-id="0" data-position="0">'.__('All Branches','nd-booking').'</li>';
	            			
	            			$nd_booking_branches_args_2 = array( 'posts_per_page' => -1, 'post_type'=> 'nd_booking_cpt_4' );
		            		$nd_booking_branches_2 = get_posts($nd_booking_branches_args_2); 
		            		$nd_booking_branches_i_2 = 1;
		            		foreach ($nd_booking_branches_2 as $nd_booking_meta_box_branche_2) :

		            			$nd_booking_shortcode_left_content .= '<li data-id="'.$nd_booking_meta_box_branche_2->ID.'" data-position="'.$nd_booking_branches_i_2.'">'.$nd_booking_meta_box_branche_2->post_title.'</li>';	
		            			$nd_booking_branches_i_2 = $nd_booking_branches_i_2 + 1;
	            	...
	            	<style>
	            	.nd_booking_branch_ul_1 { margin:0px; padding:0px; position:relative; }
	            	.nd_booking_branch_ul_1 > li{ display:none; }
					.nd_booking_branch_ul_1 .nd_booking_branch_select_active{ display:block; }
					.nd_booking_display_block_important{ display:block !important; } 
					.nd_booking_branch_ul_1 > li { padding:20px 20px 35px 20px; box-sizing:border-box; position:relative; text-align:center; }
					.nd_booking_branch_ul_1_arrow { position:absolute; bottom:15px; left: 50%; margin-left: -6px; }
					.nd_booking_branch_select_sub_menu { display:none; position:absolute; top:0px; left:0px; margin: 0px; padding:0px; list-style:none; text-align:center; cursor:pointer; min-width:300px; width:100%; z-index:9;
					}
					.nd_booking_branch_select_sub_menu li{ border-top-width:0px; padding: 14px 20px; box-sizing:border-box; position:relative; }
	            	</style>
	            	...
	            	<script type="text/javascript">
		              ...
		              jQuery(document).ready(function() {
		                ...
		                jQuery( function ( $ ) {
						    ...
						    $("  .nd_booking_branch_ul_1 li").removeClass( "nd_booking_branch_select_active" );
						    var nd_booking_select_data_position_first = $(this).attr("data-position");
						    var nd_booking_select_data_branch_id = $(this).attr("data-id");
						    var nd_booking_select_data_position = parseInt(nd_booking_select_data_position_first) + 1;
						    $("  .nd_booking_branch_ul_1 > li:nth-child("+nd_booking_select_data_position+")").addClass( "nd_booking_branch_select_active" );

						    $("  .nd_booking_branch_select_sub_menu").removeClass( "nd_booking_display_block_important" );
						  ...
						  $( "  .nd_booking_branch_ul_1 li.nd_booking_branch_select_active" ).click(function() {
						    $("  .nd_booking_branch_select_sub_menu").addClass( "nd_booking_display_block_important" );       
						  });
