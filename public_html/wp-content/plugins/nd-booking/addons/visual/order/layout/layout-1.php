...
if ( $nd_booking_current_page_permalink == nd_booking_search_page() ) {
    ...
    $str .= '
      ...
      <script type="text/javascript">
        ...
        .nd_booking_search_filter_layout_grid { background-image:url('.esc_url(plugins_url('icon-grid-grey.svg', __FILE__ )).'); }
        .nd_booking_search_filter_layout_grid.nd_booking_search_filter_layout_active { background-image:url('.esc_url(plugins_url('icon-grid-white.svg', __FILE__ )).'); }

        .nd_booking_search_filter_layout_list.nd_booking_search_filter_layout_active { background-image:url('.esc_url(plugins_url('icon-list-white.svg', __FILE__ )).'); }
        .nd_booking_search_filter_layout_list { background-image:url('.esc_url(plugins_url('icon-list-grey.svg', __FILE__ )).'); }
            	...
            	<div class="nd_booking_section nd_booking_position_relative nd_booking_line_height_0">
					...
					<ul id="nd_booking_search_filter_options" class="nd_booking_list_style_none nd_booking_display_inline_block nd_booking_padding_0 nd_booking_margin_0">
					  <li id="nd_booking_vc_order_price" class="nd_booking_display_inline_block nd_booking_position_relative nd_booking_padding_20 nd_booking_padding_bottom_15 nd_booking_margin_0 nd_booking_float_left">
					      ...
					      <img alt="" class="nd_booking_margin_left_10 nd_booking_float_left" width="10" src="'.esc_url(plugins_url('icon-down-arrow-white.svg', __FILE__ )).'">
