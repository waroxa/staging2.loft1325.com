...
/*START preview*/
$nd_booking_result .= '
<div class=" nd_booking_search_elem_component_l3 nd_booking_section '.$nd_booking_class.' ">

	<!--START FORM-->
	<form action="'.$nd_booking_action.'" method="get">


	    <div class="nd_booking_width_100_percentage nd_booking_width_100_percentage_all_iphone nd_booking_float_left nd_booking_box_sizing_border_box nd_booking_bg_white">

	        <!--check in/out-->
	        <div class="nd_booking_width_50_percentage nd_booking_width_100_percentage_all_iphone nd_booking_border_0_all_iphone nd_booking_float_left nd_booking_box_sizing_border_box">
	              ...
	              <div class="nd_booking_section  nd_booking_box_sizing_border_box nd_booking_text_align_center">
	                ...
	                <div class="nd_booking_display_inline_flex ">
	                  ...
	                  <div class="nd_booking_float_right nd_booking_text_align_center nd_booking_margin_left_10">
	                      ...
	                      <img alt="" width="12" src="'.esc_url(plugins_url('../img/icon-down-arrow-grey.svg', __FILE__ )).'">
	                  </div>
	                </div>
	              </div>
	            </div>
	        ...
	        <!--guests-->
	        <div class="nd_booking_width_100_percentage nd_booking_width_100_percentage_all_iphone nd_booking_float_left nd_booking_border_top_1_solid_grey nd_booking_padding_top_20 nd_booking_margin_top_20 nd_booking_box_sizing_border_box">
	            <div class="nd_booking_section  nd_booking_box_sizing_border_box nd_booking_text_align_center">
	              <div class="nd_booking_section  nd_booking_box_sizing_border_box nd_booking_text_align_center">
	                ...
	                <div class="nd_booking_display_inline_flex ">
	                  ...
	                  <div class="nd_booking_float_right nd_booking_text_align_center nd_booking_margin_left_10">
	                      ...
	                      <div class="nd_booking_section">
	                          <img class="nd_booking_float_right nd_booking_guests_increase nd_booking_cursor_pointer nd_booking_transform_rotate_180" alt="" width="12" src="'.esc_url(plugins_url('../img/icon-down-arrow-grey.svg', __FILE__ )).'">
	                      </div>
	                      <div class="nd_booking_section nd_booking_height_10"></div>
	                      <div class="nd_booking_section">
	                          <img class="nd_booking_float_right nd_booking_guests_decrease nd_booking_cursor_pointer" alt="" width="12" src="'.esc_url(plugins_url('../img/icon-down-arrow-grey.svg', __FILE__ )).'">
	                      </div>
	                  </div>
	                </div>
	              </div> 
	    ...
	    <div class="nd_booking_width_100_percentage nd_booking_width_100_percentage_all_iphone nd_booking_float_left nd_booking_text_align_center">

	        <input style="padding: '.$nd_booking_submit_padding.'; background-color:'.$nd_booking_submit_bg.';" class=" nd_booking_width_100_percentage nd_booking_white_space_normal nd_booking_border_width_0_important" type="submit" value="'.__('CHECK AVAILABILITY','nd-booking').'">
