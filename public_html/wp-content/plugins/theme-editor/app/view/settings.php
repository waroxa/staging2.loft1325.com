...
<div id="tabs" class="te_settings_tabs">
    ...
    <div id="theme-settings" class="te_settings_tabs_sec">
     <?php /* Theme Settings */ ?>
        ...
        <tr>
        <th scope="row"><label for="e_w_d_t_e"><?php _e('Disable wordpress theme file editor?', 'theme-editor');?></label></th>
    ...
    <div id="plugin-settings" class="te_settings_tabs_sec">
       <?php /* Plugin Settings */ ?>
        ...
        <tr>
        <th scope="row"><label for="e_w_d_p_e"><?php _e('Disable wordpress plugin file editor?', 'theme-editor');?></label></th>
