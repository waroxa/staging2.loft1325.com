            ...
            <div class="nicdark_section">
                ...
                <?php if(has_tag()) { ?>  
                    ...
                    <div id="nicdark_tags_list" class="nicdark_section nicdark_border_top_1_solid_grey nicdark_padding_top_20">
                        ...
                        <img alt="<?php esc_attr_e('Single Post Tag','marina'); ?>" width="20" class="nicdark_float_left nicdark_margin_right_20 nicdark_margin_top_4" src="<?php echo get_template_directory_uri(); ?>/img/icon-tag.svg">
                        <?php the_tags(''); ?>
                ...
                <div id="nicdark_categories_list" class="nicdark_section nicdark_border_bottom_1_solid_grey nicdark_padding_bottom_20">
                    ...
                    <img alt="<?php esc_attr_e('Single Post Category','marina'); ?>" width="20" class="nicdark_float_left nicdark_margin_right_20 nicdark_margin_top_3" src="<?php echo get_template_directory_uri(); ?>/img/icon-folder.svg">
                    <?php the_category(', '); ?>
